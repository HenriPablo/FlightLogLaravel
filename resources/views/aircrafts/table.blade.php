    ...
    @foreach($aircrafts as $aircraft)
        <tr>
            ...
            <td>
                ...
                <div class='btn-group'>
                    <a href="{!! route('aircrafts.show', [$aircraft->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-eye-open"></i></a>
                    <a href="{!! route('aircrafts.edit', [$aircraft->id]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-edit"></i></a>
